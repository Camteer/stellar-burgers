...
export const fetchRegisterUser = createAsyncThunk(
  `${USER_SLICES_NAME}/fetchRegisterUser`,
...
export const fetchLoginUser = createAsyncThunk(
  `${USER_SLICES_NAME}/fetchLoginUser`,
...
export const fetchForgotPassword = createAsyncThunk(
  `${USER_SLICES_NAME}/fetchForgotPassword`,
...
export const fetchGetUser = createAsyncThunk(
  `${USER_SLICES_NAME}/fetchGetUser`,
  async () => getUserApi()
);

export const fetchLogoutUser = createAsyncThunk(
  `${USER_SLICES_NAME}/fetchLogoutUser`,
  async () => logoutApi()
);

export const fetchUpdateUser = createAsyncThunk(
  `${USER_SLICES_NAME}/fetchUpdateUser`,
  async (user: Partial<TRegisterData>) => updateUserApi(user)
);

export const checkUserAuth = createAsyncThunk(
  `${USER_SLICES_NAME}/checkUserAuth`,
  (_, { dispatch }) => {
